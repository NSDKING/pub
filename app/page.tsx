...
export default function Home() {
  ...
  const [Orders, setOrders] = useState<Order[]>([]); // Correct type here
  ...
  const [dataFetched, setDataFetched] = useState<boolean>(false); // Add this state
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setDataFetched(true); // Set dataFetched to true after all data is loaded
    };
